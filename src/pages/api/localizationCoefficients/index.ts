...
export async function getLocalizationCoefficients(): Promise<Array<LocalizationCoefficient>> {
...
export function addLocalizationCoefficient(localizationCoefficient: LocalizationCoefficient){
...
export  function updateLocalizationCoefficients(localizationCoefficient: LocalizationCoefficient){
    return new Promise((resolve, reject) => {
        firebaseAdmin.firestore()
            .collection('localizationCoefficients')
...
export  function deleteLocalizationCoefficients(localizationCoefficient: LocalizationCoefficient){
    return new Promise((resolve, reject) => {
        firebaseAdmin.firestore()
            .collection('localizationCoefficients')
            .doc(localizationCoefficient.firebaseID)
